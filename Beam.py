...
for line in test_line:
    ...
    result = ds.hmm_probability_count_beam(tok_word, r1.tag_set, r1.hmm_tag_dictionary, r1.tag_dictionary,
                                   r1.word_dictionary, r1.tag_count_dictionary, r1.total_words, beam=10)
